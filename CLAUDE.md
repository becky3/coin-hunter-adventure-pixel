...
### PhysicsSystemリファクタリング完了
- EntityManagerを単一の真実の源として使用するように変更
- PhysicsSystemの内部エンティティ管理を削除
- ステージ遷移エラーとSpider糸降下動作を修正
- 詳細は `handover-docs/2025-07-22-physics-system-refactoring.md` を参照

### ゲームプレイ調整
- ジャンプ力を約30%減少（12.1 → 8.5）してバランス改善
- スプリング反発力を強化（2.5 → 3.5）
- スプリング無限ジャンプバグを修正

### 関連Issue/PR
- Issue #178: PhysicsSystemリファクタリング
- PR #209: PhysicsSystemのリファクタリング実装
- Issue #210: Dash機能の実装（作成済み）

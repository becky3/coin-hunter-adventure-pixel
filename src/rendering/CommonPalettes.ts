import { FourColorPalette } from '../types/animationTypes';
 ...
 */
export const DEBUG_PALETTE: FourColorPalette = {
    colors: [
        null,
        0x00,
        0x62,
 ...
 */
export const PERFORMANCE_PALETTE: FourColorPalette = {
    colors: [
        null,
        0x00,
        0x62,
 ...
 */
export const ENEMY_HP_PALETTE: FourColorPalette = {
    colors: [
        null,
        0x00,
        0x31,
 ...
 */
export const TEST_TILE_PALETTE: FourColorPalette = {
    colors: [
        null,
        0x61,
        0x21,
 ...
 */
export function getCommonPaletteIndex(palette: FourColorPalette, masterIndex: number): number {
